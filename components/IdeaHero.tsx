  ...
  const handleDownload = () => {
      ...
      try {
        ...
        const drawHeader = (pageTitle: string) => {
            ...
            doc.text("TrendPulse Intelligence", margin, 15);
        ...
        const drawFooter = (pageNum: number, totalPages: number) => {
            ...
            doc.text("Generated by TrendPulse AI", pageWidth - margin - 35, pageHeight - 10);
        };
        ...
        // Market Dynamics (Right Column) - Positioned manually
        const rightColX = 110;
        let rightY = 40;
        doc.setFontSize(14);
        ...
        doc.setFontSize(10);
        doc.setTextColor(C_GRAY[0], C_GRAY[1], C_GRAY[2]);
        doc.text(`Current Vol: ${idea.currentVolume} | Growth: +${idea.growthPercentage}%`, margin, y + 6);
        y += 15;
        ...
        const maxVol = Math.max(...idea.chartData.map(d => d.volume));
        const xStep = chartW / (idea.chartData.length - 1);
        ...
        // --- PAGE 4: EXECUTION & VERDICT ---
        doc.addPage();
        drawHeader("Execution & Verdict");
        y = 45;
        ...
        // --- FINAL VERDICT (Summarization) ---
        doc.setFontSize(14);
        doc.setFont("helvetica", "bold");
        doc.setTextColor(C_DARK[0], C_DARK[1], C_DARK[2]);
        doc.text("Final Analysis", margin, y);
        y += 8;
